        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="ax_form" role="form" method="post" action="<?php echo U('Admin/Root/save');?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>成员</label>
                                    <?php if(is_array($users)): foreach($users as $key=>$vo): ?><label class="checkbox-inline">
                                        <input type="checkbox" name="users[]" value="<?php echo ($vo["uid"]); ?>"
                                        <?php if($vo["have"] == 1): ?>checked onclick="return false;"<?php endif; ?>
                                        ><?php echo ($vo["username"]); ?>
                                    </label><?php endforeach; endif; ?>
                                </div>
                                <div class="form-group">
                                    <label>权限</label>
                                    <?php if(is_array($rules)): foreach($rules as $key=>$vo): ?><label class="checkbox-inline">
                                        <input type="checkbox" name="rules[]" value="<?php echo ($vo["id"]); ?>"
                                        <?php if($vo["have"] == 1): ?>checked<?php endif; ?>
                                        ><?php echo ($vo["title"]); ?>
                                    </label><?php endforeach; endif; ?>
                                </div>           
