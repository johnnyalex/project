        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/Index/insert');?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(is_array($res)): foreach($res as $key=>$vo): ?><label class="checkbox-inline">
                                        <input type="radio" name="type" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?>
