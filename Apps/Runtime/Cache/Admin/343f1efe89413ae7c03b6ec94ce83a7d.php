            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        ...
                        <li class="divider"></li>
                        <li><a href="<?php echo U('Admin/Index/login',['remember'=>0]);?>"><i class="fa fa-sign-out fa-fw"></i> 退出</a>
                        </li>
                    </ul>
                    <!-- /.dropdown-user -->
                </li>
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="ax_form" role="form" method="post" action="<?php echo U('Admin/Category/change');?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>一级类别</label>
                                    <select name="level" class="form-control">
                                        <option value="0" path="0,">一级分类</option>
                                    <?php if(is_array($res)): foreach($res as $key=>$vo): ?><option value="<?php echo ($vo["id"]); ?>" path="<?php echo ($vo["path"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; ?>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label>分类名称</label>
