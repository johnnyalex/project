        ...
        <table id="dataTables-example" class="table table-striped table-bordered table-hover dataTable no-footer" role="grid" aria-describedby="dataTables-example_info">
         ...
         <tbody>
          ...
          <?php if(is_array($users)): foreach($users as $key=>$vo): ?><tr class="gradeA odd" role="row">
            ...
            <td class="user_name"><?php echo ($vo["username"]); ?></td>
            <td class="center"><?php echo ($vo["title"]); ?></td>
            <td class="center"><?php echo ($vo["login_ip"]); ?></td>
            <td class="center"><?php echo ($vo["login_time"]); ?></td>
            <td class="center"><?php echo ($vo["login_count"]); ?></td>
...
<script type="text/javascript">
	$(function(){
        ...
        var v = $(this).parents('.gradeA').find('.sid').html();
			var url = "<?php echo U('Admin/Index/delete');?>";
			var btn = $(this);
			$.ajax({
        url:url,
        data:{id:v},
    ...
    $('.user_name').dblclick(function(){
      ...
      inp.blur(function(){
        ...
        $.post("<?php echo U('Admin/Index/update');?>",{id:id,username:newV},function(data){
          if(data){
            td.html(newV);
          }else{
            td.html(v);
