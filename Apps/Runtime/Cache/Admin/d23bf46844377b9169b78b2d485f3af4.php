...
<body>
    ...
    <script type="text/javascript" charset="utf-8" src="/AAA/project/Public/Admin/ueditor/ueditor.config.js"></script>
    <script type="text/javascript" charset="utf-8" src="/AAA/project/Public/Admin/ueditor/ueditor.all.min.js"> </script>
    <script type="text/javascript" charset="utf-8" src="/AAA/project/Public/Admin/ueditor/lang/zh-cn/zh-cn.js"></script>
    <div class="row">
        <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <form role="form" method="post" action="<?php echo U('Admin/Goods/insert');?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <!-- <?php if(!empty($name)): ?>name不为空<?php endif; ?> -->
                                </div>
                                <div class="form-group">
                                    <label>商品分类</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <label class="radio-inline">
                                        <input  type="radio" name="status" id="optionsRadiosInline1" value="1">上架
                                    </label>
                                    <label class="radio-inline">
                                        <input  type="radio" name="status" id="optionsRadiosInline1" value="0">下架
                                    </label>
                                </div>
                                ...
                                <div class="form-group">
                                    <label>是否热销 : </label>
                                    <label class="radio-inline">
                                        <input  type="radio" name="is_host" id="optionsRadiosInline1" value="1">热销
                                    </label>
                                    <label class="radio-inline">
                                        <input  type="radio" name="is_host" id="optionsRadiosInline1" value="0">畅销
                                    </label>
                                </div>
                                <div class="form-group">
                                      <label>是否精品 : </label>
                                    <label class="radio-inline">
                                        <input  type="radio" name="is_best" id="optionsRadiosInline1" value="1">精品
                                    </label>
                                    <label class="radio-inline">
                                        <input  type="radio" name="is_best" id="optionsRadiosInline1" value="0">不精
                                    </label>
                                </div>
                                <div class="form-group">
                                    <label>是否新品 : </label>
                                    <label class="radio-inline">
                                        <input  type="radio" name="is_new" id="optionsRadiosInline1" value="1">新款
                                    </label>
                                    <label class="radio-inline">
                                        <input  type="radio" name="is_new" id="optionsRadiosInline1" value="0">老款
                                    </label>
                                    
                                </div>
                                <div class="form-group">
                                    <label>商品详情</label>
                                    <script id="editor" name="describe" type="text/plain" style="width:750px;height:300px;"></script>
