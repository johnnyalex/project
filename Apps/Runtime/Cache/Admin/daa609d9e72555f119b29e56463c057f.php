        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="ax_form" role="form" method="post" action="<?php echo U('Admin/Root/groupinsert');?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label>分组名称</label>
                                    <input name="title" placeholder="请输入权限名称" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>权限</label>
                                    <?php if(is_array($res)): foreach($res as $key=>$vo): ?><label class="checkbox-inline">
                                        <input type="checkbox" name="rules[]" value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["title"]); ?>
