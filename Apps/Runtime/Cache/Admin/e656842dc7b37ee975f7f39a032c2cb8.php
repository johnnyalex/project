        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <form class="ax_form" role="form" method="post" action="<?php echo U('Admin/Root/insert');?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    <label>规则路径</label>
                                    <input name="name" placeholder="请输入规则" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label>状态</label>
