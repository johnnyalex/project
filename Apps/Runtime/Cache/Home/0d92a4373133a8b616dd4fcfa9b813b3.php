	...
	<div id="bu">
		<div class="goods-left fl">
			<div class="goods-left-l fl">
				<div class="goods-left-count" id="small">
					<img id="simg" width="100%" src="/Public/Home/images/a.jpg">
					<div id="move" style="background:url('/Public/Home/images/bg.png');"></div>
				</div>
				<div class="big" id="big"><img id="bimg" style="position: absolute;left:0px;top:0px"  src="/Public/Home/images/a.jpg"></div>
				<div class="d">
					<ul id="uimg">
						<li class="small fl"><img width="100%" src="/Public/Home/images/a.jpg"></li>
						<li class="small fl"><img width="100%" src="/Public/Home/images/2.jpg"></li>
						<li class="small fl"><img width="100%" src="/Public/Home/images/b.jpg"></li>
						<li class="small fl"><img width="100%" src="/Public/Home/images/c.jpg"></li>
						<li class="small fl"><img width="100%" src="/Public/Home/images/2.jpg"></li>
					</ul>
				</div>	
			</div>
		...
		<div class="goods-right fr">
			...
			<ul>
				<li>         
					<div class="img">
						<a href=""> <img src="/Public/Home/images/d.jpg"alt="遍历图片"></a>                                                    
