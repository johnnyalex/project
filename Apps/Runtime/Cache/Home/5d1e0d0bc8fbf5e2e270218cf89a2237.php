...
<<<<<<< HEAD
    ...
    <link rel="stylesheet" type="text/css" href="/Public/Home/Css/add1.css" />
    <link rel="stylesheet" type="text/css" href="/Public/Home/Css/add2.css" />
...
>>>>>>> e4f34d0e1f20f1b37c059a3b940567e2687b44ec
    ...
    <link rel="stylesheet" type="text/css" href="/BBBB/project/Public/Home/Css/add.css" />
    <link rel="stylesheet" type="text/css" href="/BBBB/project/Public/Home/Css/add1.css" />
    <link rel="stylesheet" type="text/css" href="/BBBB/project/Public/Home/Css/add2.css" />
    <link rel="stylesheet" type="text/css" href="/BBBB/project/Public/Home/Css/pg-myjuanpi.css" />
    <!-- desc 商品 -->
        <link href="/BBBB/project/Public/Home/css/css.css" rel="stylesheet">

    <script type="text/javascript" src="/BBBB/project/Public/Home/Js/d0516eb91e74494cbb77cf76d6c5cf9b.js"></script>
    <script type="text/javascript" src="/BBBB/project/Public/Home/Js/ab9affd4df7949768bc618ce97b36da9.js"></script>
...
>>>>>>> e4f34d0e1f20f1b37c059a3b940567e2687b44ec
        ...
        <li><a href="<?php echo U('Home/Center/userinfo');?>"><span>账号设置</span></a></li><li><a href="http:####.juanpi.com/login/logout"><span>退出</span></a></li></ul></div></div><div class="personal-show"><a href="http:####.juanpi.com/order"><span>我的订单</span></a><a href="###.juanpi.com/jifen"><span>积分商城</span></a><a href="http:####.juanpi.com/message"><span>我的消息</span><em style="display: none;" class="count">0</em></a>&#12288;|</div><div class="bag-show"><a class="bag-a" target="_blank" href="http://cart.juanpi.com"><span class="icon-normal icon-bag fl empty"></span><span class="empty fl"><span class="fl empty">购物袋</span><em class="num cartnum" style="background: rgb(204, 204, 204) none repeat scroll 0% 0%;">0</em></span></a><div style="" class="bag-tool bag-tool-empty"><div style="display:none;" id="loadingimg"></div><p><span class="icon-normal icon-bag-empty"></span>购物袋还是空荡荡的~</p></div>&#12288;|</div><div class="other-show"><a target="_blank" href="https://seller.juanpi.com/choice">卖家报名</a></div><div class="other-show other-show01"><a>客户服务</a><div class="normal-box01"><ul><li><a rel="nofollow" target="_blank" href="###.juanpi.com/help">帮助中心</a></li><li><a rel="nofollow" target="_blank" href="###.juanpi.com/about/service">联系客服</a></li></ul></div></div></div>
            ...
            <!-- 导航 -->
<!--head start-->
<div class="header header-myjp">
    <div class="area">
    <a title="卷皮首页" href="###.juanpi.com">
        <div class="logo juan-user">
            <div class="fl"><span class="other-logo fl"></span></div>
        </div>
    </a>
    <div class="protection">
        <a rel="nofollow" title="每天10点开抢" class="update" href="###.juanpi.com/help/xiaobao" target="_blank"></a>
        <a rel="nofollow" title="职业买手砍价" class="lowest" href="###.juanpi.com/help/xiaobao#consumer03" target="_blank"></a>
...
<div class="sider-bar">
    <ul>
    <li class="noboder"><a href="">我的订单</a></li>
    <li class="sub-menu">
        <ul>
            <li><a href="<?php echo U('Home/Center/allOrder');?>">全部订单</a></li>
            <li><a href="<?php echo U('Home/Center/noPayOrder');?>">待付款</a><span>0</span></li>
            <li><a href="<?php echo U('Home/Center/inWayOrder');?>">运送中</a><span>0</span></li>
        </ul>
    </li>
    <li><a href="<?php echo U('Home/Center/backList');?>">我的售后</a></li>
    <li><a href="<?php echo U('Home/Center/beans');?>">我的积分</a></li>
    <li><a href="<?php echo U('Home/Center/coupon');?>">我的优惠券</a></li>
    <li class="noboder"><a href="<?php echo U('Home/Center/favorite');?>" target="_blank">我的收藏</a></li>
    </ul>
</div>
            <!-- 二级导航 -->
...
>>>>>>> e4f34d0e1f20f1b37c059a3b940567e2687b44ec
                    alt="头像" 
                    >
                        <a href="###.juanpi.com/setting">
                            <div class="ph-layer"></div>
                            <div class="ph-set" style="background-position: -138px -21px;"></div>
                        </a>
                    </div>
                    <div class="account-info">
                        <p><span>Hi~</span> <a href="###.juanpi.com/setting"><?php echo ($user["username"]); ?></a>
                                                    </p>
                        <div class="tips"><span>账户安全级别：</span>
                            <strong class="level-h">高</strong>                                                                                                                <a href="<?php echo U('Home/Center/security');?>">立即提升</a>
                            <span style="color:#e2e2e2">|</span>
                            <a href="/setting/security?method=verifyphone"><em class="active"><div class="mobile"></div></em></a>
                            <a href="/setting/security?method=verifyemail"><em class="active"><div class="mail"></div></em></a>
                            <a href="/setting/security?method=resetpwd"><em class="active"><div class="lock">&nbsp;</div></em></a>
                        </div>
                    </div>
                </div>
                <ul>
                    <li><div class="credit"><a href="<?php echo U('Home/Center/beans');?>">我的积分：642</a></div></li>
                    <li><div class="ticket"><a href="<?php echo U('Home/Center/coupon');?>">我的优惠券：0</a></div></li>
                    <li><div class="base-info"><a href="<?php echo U('Home/Center/index');?>">基本资料</a></div></li>
                    <li><div class="addr"><a href="<?php echo U('Home/Center/address');?>">收货地址</a></div></li>
                </ul></div>
        <div class="order-lists">
                <div class="all-orders">
                    <div class="all-orders-top">
                        ...
                        <span class="order_t">
                           <select id="orderStatus" name="status" class="state-select">
                               <option data-msg="订单状态" value="all">订单状态</option>
                               <option data-msg="待付款" value="1">待付款</option>
                               <option data-msg="待发货" value="3">待发货</option>
                               <option data-msg="运送中" value="4">运送中</option>
                               <option data-msg="已送达" value="5">已送达</option>
                               <option data-msg="已关闭" value="6">已关闭</option>
                               <!-- <option value="20"  data-msg="售后处理中">售后处理中</option>-->
                           </select>
                       </span>
                        <a href="###.juanpi.com/order/index/flag/1">查看所有订单&gt;&gt;</a>
                    </div>
                    <!-- 防诈骗BANNER图片BEGIN -->
        ...
        <div class="order-info-hd">
            <span class="order-time">2016-03-11 18:55:05</span>
                            <span orderback="0" _order_no="314576937049262" _soid_no="314576937049262" class="order-no"><b>订单号：</b>314576937049262</span>
                                        <span class="seller">商家：山予味道</span>
                                                                <span _soid_no="314576937049262" href="javascript:;" class="bin closebtn closebtnAction"></span>
                    </div>
        <dl class="my-order-list">
            <dd>
                        ...
                        <ul class="last-goods">
                        <li class="oi-goods">
                            <a href="http://shop.juanpi.com/deal/6937042" target="_blank" class="aimg">
                                <img width="60px" height="60px" src="//s2.juancdn.com/bao/151203/b/6/565fb95592be59335d8b457b_800x800.jpg?iopcmd=thumbnail&amp;type=8&amp;width=100&amp;height=100%7Ciopcmd=convert&amp;Q=88&amp;dst=jpg">
                            </a>
                            <div class="con">
                                <a href="http://shop.juanpi.com/deal/6937042" target="_blank">
                                    <div class="good-name">山予闽南荔枝干(500g)</div>
                                </a>
                                <div class="other"></div>
                            </div>
                        </li>
                        ...
                        <li class="oi-other">
                            <a target="_blank" href="###.juanpi.com/refund?giOrderId=52570392&amp;boid=&amp;botype="></a> 
                        </li>

                            <!-- <a>退货/退款</a> <p>售后完成</p> -->
                        <li class="oi-count">
                                <p class="all"><em class="u-yen">¥</em><span>10.80</span></p>
                                <div class="mobile_order"><i></i>手机订单<div></div></div>
                        </li>
                        <li class="oi-status">
                                <p>
                                   <b class="wait-pay">已送达</b>
                                </p>
                                <p><a target="_blank" href="###.juanpi.com/order/detail/orderId/314576937049262">订单详情</a></p>
                                <p><a target="_blank" href="###.juanpi.com/order/detail/orderId/314576937049262#logistics">订单跟踪</a></p>
                        </li>
                        <li class="oi-button">
                        </li>
                    </ul>
    ...
    <div class="foot-con">
        <div class="con-box-n clear">
            ...
            <div class="con-left-info fl">
                <dl class="update">
                    <dt>获取更新</dt>
                    <dd><a target="_blank" href="###.juanpi.com/apps"><i></i>iPhone/Android</a></dd>
                    <dd><a target="_blank" href="http:####.qzone.qq.com/474171717"><i></i>卷皮QQ空间</a></dd>
                    <dd><a target="_blank" href="http://weibo.com/juanpicom"><i></i>卷皮新浪微博</a></dd>
                    <dd><a target="_blank" href="###.juanpi.com/about/api"><i></i>开放API</a></dd>
                </dl>
                <dl class="cooperation">
                    <dt>商务合作</dt>
                    <dd><a target="_blank" href="https://seller.juanpi.com/choice"><i></i>卖家免费报名</a></dd>
                    <dd><a target="_blank" href="###.juanpi.com/about/partner"><i></i>商务合作</a></dd>
                    <dd><a href="javascript:void(0)" onclick="if (window.confirm('本邮箱仅接收合作商家对卷皮员工违规行为的举报。不接受用户咨询、投诉或商务合作申请。')) { window.location = 'mailto:' + 'moc.ipnauj@gnehznail'.split('').reverse().join(''); }"><i></i>廉政邮箱<br><span class="revEmail">lianzheng@juanpi.com</span></a></dd>
                </dl>
                <dl class="cor-info">
                    <dt>公司信息</dt>
                    <dd><a target="_blank" href="###.juanpi.com/about/juanpi"><i></i>关于卷皮</a></dd>
                    <dd><a target="_blank" href="###.juanpi.com/about/media"><i></i>媒体报道</a></dd>
                    <dd class="school"><a target="_blank" href="###.juanpi.com/about/job"><i></i>诚聘英才</a><a target="_blank" href="###.juanpi.com/about/job_2015campus"><em></em></a></dd>
                    <dd><a target="_blank" href="###.juanpi.com/event/xiaoyuan_zhaomu"><i></i>校园大使招募</a></dd>
                </dl>
                <dl class="help-info">
                    <dt>帮助中心</dt>
                    <dd><a target="_blank" href="###.juanpi.com/help"><i></i>新手上路</a></dd>
<!--                     <dd><a href="###.juanpi.com/help/qianggou" target="_blank"><i></i>抢购小技巧</a></dd> -->
                    <dd><a target="_blank" href="###.juanpi.com/jifen/task"><i></i>积分攻略</a></dd>
                    <dd><a target="_blank" href="###.juanpi.com/about/map"><i></i>网站地图</a></dd>
                </dl>
            </div>
            <div class="con-menu fr">
                <a rel="nofollow" target="_blank" class="service-add fl" href="###.juanpi.com/about/service"></a>
