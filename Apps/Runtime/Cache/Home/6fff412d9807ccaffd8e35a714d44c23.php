...
<div class="main-center">                
       ...
       <div class="per_content  fl safe_center">
        <form id="" action="<?php echo U('Home/Center/do_check_question');?>" method="POST">
            <ul>
                <li>
                    <label class="bold_phone">验证密保</label>
            ...
            <div class='question'>
                <li class="reset_one">
                    <label>问题一：</label>
                    <select name="q1">
                        <option value=""><?php echo ($res["q1"]); ?></option>
                    </select>
            ...
            <div class='question'>
                <li class="reset_one">
                    <label>问题二：</label>
                    <select name="q2">
                        <option value=""><?php echo ($res["q2"]); ?></option>
            ...
            <div class='question'>
                <li class="reset_one">
                    <label>问题三：</label>
                    <select name="q3">
                        <option value=""><?php echo ($res["q3"]); ?></option>
