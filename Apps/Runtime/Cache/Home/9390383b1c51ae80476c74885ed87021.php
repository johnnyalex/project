...
<div class="confirm-order main-center main-zhanghu">
    <div class="order-address clear">
        ...
        <form action="<?php echo U('Home/Center/do_add_addr');?>" method="post">
                    ...
                    <div class="adr" id="adr">
                        <ul>
                            <li>
                                ...
                                <input type="text" class="text" name="name" id="truename" size="16" maxlength="16" tabindex="1">
                            ...
                            <li>
                                ...
                                <input placeholder="省份" type="text" value="" name="pro" id="mobile" style="height:31px" size="12" maxlength="11" tabindex="2" class="text">
                                <input placeholder="城市" type="text" value="" name="city" id="mobile" style="height:31px" size="12" maxlength="11" tabindex="2" class="text">
                                <input placeholder="区域" type="text" value="" name="area" id="mobile" style="height:31px" size="12" maxlength="11" tabindex="2" class="text">
                                <p style="display:none;" class="s13"></p>
                            </li>
                            <li>
                                <label> <!-- <span class="import">*</span> -->地址：</label>
                                <input type="text" value="" name="addr" id="addr" size="45" maxlength="40" tabindex="6" class="text addr-long">
                                <p style="display:none;" class="s13"></p>
                            ...
                            <li>
                                <label></label>
                                <input type="submit" class="smt smt1 baocun" value="保 存" tabindex="9">
                            </li>
                        </ul>
                    </div>
                    </div>
