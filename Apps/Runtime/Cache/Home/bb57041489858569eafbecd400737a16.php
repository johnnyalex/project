            ...
            <div class="main-zhanghu" >
               ...
               <div class="main-zhanghu" >
                       ...
                       <div style="display:block;" class="per_content fl">
                           ...
                           <form action="<?php echo U('Home/Center/do_set');?>" method="post" class="user-info" id="userform">
                               <ul class="fl">
                                   <li><label><span class="import"></span>用户名：</label>
                                   <span class="right_modify"><?php echo ($user["username"]); ?></span>                                </li>
                                   <li>
                                       <label>性 别：</label>
                                       <input type="radio"  id="male" name="sex" value="男" <?php if($user["sex"] == 0): ?>checked<?php endif; ?>/><label class="normal" for="male">男</label>
                                       <input type="radio"  id="female" name="sex" value="女" <?php if($user["sex"] == 1): ?>checked<?php endif; ?>/><label for="female" class="normal">女</label>
                                       <p class="s13"></p>
                                   </li>
                                   <li><label>生 日：</label>
                                       <select id="year" name="year" size="1">
                                           <?php for ($i=1970; $i <= date('Y',time()); $i++) { ?> 
                                           <option value="<?php echo $i ?>"><?php echo $i ?></option>
                                           <?php } ?>
                                       </select><span class="right_modify">年</span>
                                       <select id="month" name="month" size="1"> 
                                           <?php for ($i=1; $i <= date('m',time()) ; $i++) { ?>
                                           <option value="<?php echo $i ?>"><?php echo $i ?></option>
                                           <?php } ?>
                                       </select> <span class="right_modify">月</span>
                                       <select id="day"  name="day" size="1">
                                           <?php for ($i=1; $i <= date('d',time()) ; $i++) { ?>
                                           <option value="<?php echo $i ?>"><?php echo $i ?></option>
                                           <?php } ?>
